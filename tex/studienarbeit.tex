...
\end{tcolorbox}
    ...
    Die Variable \texttt{NEIGHBORS} ist ein Dictionary, welches alle
Nachbarfelder von jeder Spielposition speichert. Um das Dictionary zu
erstellen, wird über jede Spielposition iteriert. In jeder Iteration
werden die Nachbarfelder auf dem Ring in eine Menge geschrieben. Falls
die Spielposition auf einer Querverbindung liegt, werden die
entsprechenden Nachbarn ebenso in die Menge geschrieben. Am Ende jeder
Iteration wird die generierte Menge in das Dictionary gespeichert.

Somit existiert für jede Spielposition ein Eintrag in
\texttt{NEIGHBORS}, welcher eine Menge von allen Nachbarfeldern enthält.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{NEIGHBORS} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}

\PY{k}{for} \PY{n}{r} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{:}
    \PY{k}{for} \PY{n}{c} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{8}\PY{p}{)}\PY{p}{:}
        \PY{n}{neighbor} \PY{o}{=} \PY{p}{\PYZob{}}
            \PY{p}{(}\PY{n}{r}\PY{p}{,} \PY{p}{(}\PY{n}{c}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)} \PY{o}{\PYZpc{}} \PY{l+m+mi}{8}\PY{p}{)}\PY{p}{,}
            \PY{p}{(}\PY{n}{r}\PY{p}{,} \PY{p}{(}\PY{n}{c}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)} \PY{o}{\PYZpc{}} \PY{l+m+mi}{8}\PY{p}{)}\PY{p}{,}
        \PY{p}{\PYZcb{}}
        \PY{k}{if} \PY{n}{c} \PY{o}{\PYZpc{}} \PY{l+m+mi}{2} \PY{o}{==} \PY{l+m+mi}{1}\PY{p}{:}
            \PY{k}{if} \PY{n}{r} \PY{o}{\PYZgt{}} \PY{l+m+mi}{0}\PY{p}{:}
                \PY{n}{neighbor}\PY{o}{.}\PY{n}{add}\PY{p}{(}\PY{p}{(}\PY{n}{r}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{c}\PY{p}{)}\PY{p}{)}
            \PY{k}{if} \PY{n}{r} \PY{o}{\PYZlt{}} \PY{l+m+mi}{2}\PY{p}{:}
                \PY{n}{neighbor}\PY{o}{.}\PY{n}{add}\PY{p}{(}\PY{p}{(}\PY{n}{r}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{c}\PY{p}{)}\PY{p}{)}
        \PY{n}{NEIGHBORS}\PY{p}{[}\PY{p}{(}\PY{n}{r}\PY{p}{,} \PY{n}{c}\PY{p}{)}\PY{p}{]} \PY{o}{=} \PY{n}{neighbor}
\end{Verbatim}
\end{tcolorbox}
...
Die Funktion überprüft mit Hilfe der Konstanten \texttt{NEIGHBORS} alle
Nachbarfelder, ob diese frei sind.
...
\PY{k}{def} \PY{n+nf}{findNeighboringEmptyCells}\PY{p}{(}\PY{n}{board}\PY{p}{,} \PY{n}{coordinates}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{p}{\PYZob{}}
        ...
        \PY{k}{for} \PY{p}{(}\PY{n}{r}\PY{p}{,} \PY{n}{c}\PY{p}{)} \PY{o+ow}{in} \PY{n}{NEIGHBORS}\PY{p}{[}\PY{n}{coordinates}\PY{p}{]}
        \PY{k}{if} \PY{n}{board}\PY{p}{[}\PY{n}{r}\PY{p}{]}\PY{p}{[}\PY{n}{c}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ }\PY{l+s+s1}{\PYZsq{}}
    \PY{p}{\PYZcb{}}
\end{Verbatim}
\end{tcolorbox}
...
im nächsten Zug möglich ist, diese Mühle zu vervollständigen. Dabei hat
die Funktion zwei Argumente:
...
\end{tcolorbox}
    ...
    Die Funktion \texttt{poundStones} errechnet aus einem Spielbrett, einer
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{poundStones}\PY{p}{(}\PY{n}{board}\PY{p}{,} \PY{n}{count}\PY{p}{,} \PY{n}{p}\PY{p}{)}\PY{p}{:}
    ...
    \PY{k}{return} \PY{p}{\PYZob{}}
        ...
        \PY{k}{for} \PY{n}{b} \PY{o+ow}{in} \PY{n}{poundStones}\PY{p}{(}\PY{n}{board}\PY{p}{,} \PY{n}{count}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{p}\PY{p}{)}
        \PY{k}{for} \PY{n}{cell} \PY{o+ow}{in} \PY{n}{getCellsPoundable}\PY{p}{(}\PY{n}{b}\PY{p}{,} \PY{n}{p}\PY{p}{)}
    \PY{p}{\PYZcb{}}
\end{Verbatim}
\end{tcolorbox}

    Die Funktion \texttt{poundMills} errechnet für jedes gegebene Spielbrett
aus \texttt{newBoards} wie viele neue Mühlen im Vergleich zu den bereits
existierenden Mühlen \texttt{mills} existieren. Die resultierende Anzahl
wird verwendet um für das jeweilige Spielbrett die richtige Anzahl an
Steinen zu schlagen. Die Funktion hat 3 Parameter:

\begin{itemize}
\tightlist
\item
  \texttt{mills} ist eine Menge von Mühlen;
\item
  \texttt{newBoards} ist eine Menge von Spielbrettern;
\item
  \texttt{p} \(\in Players\).
\end{itemize}

Der Rückgabewert ist eine Menge mit allen möglichen
Spielbrettkonstellationen, bei denen die erlaubte Anzahl an gegnerischen
Steinen geschlagen wurde.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{poundMills}\PY{p}{(}\PY{n}{mills}\PY{p}{,} \PY{n}{newBoards}\PY{p}{,} \PY{n}{player}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{p}{\PYZob{}}
        \PY{n}{result}
        \PY{k}{for} \PY{n}{board} \PY{o+ow}{in} \PY{n}{newBoards}
        \PY{k}{for} \PY{n}{result} \PY{o+ow}{in} \PY{n}{poundStones}\PY{p}{(}
            \PY{n}{board}\PY{p}{,}
            \PY{n}{countNewMills}\PY{p}{(}\PY{n}{board}\PY{p}{,} \PY{n}{mills}\PY{p}{,} \PY{n}{player}\PY{p}{)}\PY{p}{,}
            \PY{n}{player}
        \PY{p}{)}
    \PY{p}{\PYZcb{}}
\end{Verbatim}
...
\[G_{Nine Men's Morris} = \langle States,s_0,Players,nextStates,finished,utility \rangle \]
...
\tightlist
\item
  Der beginnende Spieler weiß wird als \texttt{w} dargestellt,
\item
  der gegnerische Spieler als \texttt{b}.
\end{itemize}
...
(\texttt{state}) ist ein Tupel, das

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  den Stapel (\texttt{stash}) von zu legenden Steinen und
\item
  das Spielbrett (\texttt{board}) selbst
\end{enumerate}
...
\item
  Nun wird vom Stapel des Spielers \texttt{p} ein Stein weg genommen.
\item
...
\PY{k}{def} \PY{n+nf}{nextStatesPlace}\PY{p}{(}\PY{n}{s}\PY{p}{,} \PY{n}{p}\PY{p}{)}\PY{p}{:}
    ...
    \PY{c+c1}{\PYZsh{} Pound a stone for every new mill}
    \PY{k}{return} \PY{p}{\PYZob{}}
        \PY{p}{(}\PY{p}{(}\PY{n}{cw}\PY{p}{,} \PY{n}{cb}\PY{p}{)}\PY{p}{,} \PY{n}{board}\PY{p}{)}
        \PY{k}{for} \PY{n}{board} \PY{o+ow}{in} \PY{n}{poundMills}\PY{p}{(}\PY{n}{mills}\PY{p}{,} \PY{n}{placeBoards}\PY{p}{,} \PY{n}{p}\PY{p}{)}
    \PY{p}{\PYZcb{}}
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{def} \PY{n+nf}{nextStatesMove}\PY{p}{(}\PY{n}{s}\PY{p}{,} \PY{n}{p}\PY{p}{)}\PY{p}{:}
    ...
    \PY{k}{return} \PY{p}{\PYZob{}}
        \PY{p}{(}\PY{p}{(}\PY{n}{cw}\PY{p}{,} \PY{n}{cb}\PY{p}{)}\PY{p}{,} \PY{n}{board}\PY{p}{)}
        \PY{k}{for} \PY{n}{board} \PY{o+ow}{in} \PY{n}{poundMills}\PY{p}{(}\PY{n}{mills}\PY{p}{,} \PY{n}{moveBoards}\PY{p}{,} \PY{n}{p}\PY{p}{)}
    \PY{p}{\PYZcb{}}
\end{Verbatim}
\end{tcolorbox}
...
\item
  Danach werden die Positionen aller Steine des Spielers \texttt{p} und
  die Positionen aller leeren Zellen mit Hilfe der Funktionen
  \texttt{findCellsOf} und \texttt{findEmptyCells} errechnet. Die Steine
  werden dort hin bewegt.
\item
  Im nächsten Schritt wird mit der Hilfsfunktion \texttt{poundMills}
  errechnet, ob neue Mühlen in diesem Zug entstanden sind. Wenn ja, wird
  direkt die richtige Anzahl an gegnerischen Steinen geschlagen.
...
\PY{k}{def} \PY{n+nf}{nextStatesFly}\PY{p}{(}\PY{n}{s}\PY{p}{,} \PY{n}{p}\PY{p}{)}\PY{p}{:}
    ...
    \PY{c+c1}{\PYZsh{} Choose any stone of the player and move it to an empty neighbor}
    \PY{n}{flyBoards} \PY{o}{=} \PY{p}{\PYZob{}}
        \PY{n}{move}\PY{p}{(}\PY{n}{board}\PY{p}{,} \PY{n}{src}\PY{p}{,} \PY{n}{des}\PY{p}{)}
        \PY{k}{for} \PY{n}{src} \PY{o+ow}{in} \PY{n}{findCellsOf}\PY{p}{(}\PY{n}{board}\PY{p}{,} \PY{n}{p}\PY{p}{)}
    ...
    \PY{k}{return} \PY{p}{\PYZob{}}
        \PY{p}{(}\PY{p}{(}\PY{n}{cw}\PY{p}{,} \PY{n}{cb}\PY{p}{)}\PY{p}{,} \PY{n}{board}\PY{p}{)}
        \PY{k}{for} \PY{n}{board} \PY{o+ow}{in} \PY{n}{poundMills}\PY{p}{(}\PY{n}{mills}\PY{p}{,} \PY{n}{flyBoards}\PY{p}{,} \PY{n}{p}\PY{p}{)}
    \PY{p}{\PYZcb{}}
\end{Verbatim}
\end{tcolorbox}
...
\tightlist
\item
  einer der Spieler \(p \in Players\) weniger als 3 Steine hat
  (\texttt{hasEnoughStones}) oder
\item
  der Spieler \texttt{p} keinen legalen Zug mehr tätigen kann.
\end{itemize}
...
\PY{k}{def} \PY{n+nf}{utility}\PY{p}{(}\PY{n}{s}\PY{p}{,} \PY{n}{p}\PY{p}{,} \PY{n}{ns}\PY{o}{=}\PY{k+kc}{None}\PY{p}{)}\PY{p}{:}
    ...
    \PY{k}{assert} \PY{k+kc}{False}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{utility() called without finished() = True}\PY{l+s+s2}{\PYZdq{}}
\end{Verbatim}
\end{tcolorbox}
...
\tightlist
\item
  \texttt{stones}: Diese Eigenschaft zählt, wie viele Steine der Spieler
  auf dem Spielbrett hat.
\item
  \texttt{stash}: Die Steine auf dem Stapel werden ebenfalls gezählt.
\item
  \texttt{mills}: Die Anzahl der Mühlen, die ein Spieler auf dem
  Spielbrett hat, wird durch diese Eigenschaft gezählt.
\item
  \texttt{possible\_mills}: Die Anzahl der möglichen Mühlen, dh. Mühlen
...
\tightlist
\item
  die \emph{horizontale} und \emph{vertikale} Achse, sowie
\item
  die Diagonale von oben links nach unten rechts (\emph{negative
  Diagonale}) und die Diagonale von unten links nach oben rechts
  (\emph{positive Diagonale}).
\end{itemize}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{symmetryDiagonalNegative}\PY{p}{(}\PY{n}{boards}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{p}{\PYZob{}}
        \PY{n+nb}{tuple}\PY{p}{(}
            \PY{n+nb}{tuple}\PY{p}{(}
...
\PY{k}{def} \PY{n+nf}{findSymmetries}\PY{p}{(}\PY{n}{state}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{boards} \PY{o}{|}\PY{o}{=} \PY{n}{symmetryDiagonalNegative}\PY{p}{(}\PY{n}{boards}\PY{p}{)}
...
\item
  \texttt{limit} beschreibt die verwendete maximale Rekursionstiefe;
\item
  \texttt{cache\_hit} ist die Anzahl der Berechnungen, die durch die
  Transpositionstabelle (\texttt{cache}) eingespart werden konnten;
\item
  \texttt{cache\_miss} hingegen ist die Anzahl der Berechnungen, die
  trotz der Transpositionstablle durchgeführt werden mussten.
\end{itemize}
...
\subsection{$\alpha$-$\beta$-Pruning}\label{ux3b1-ux3b2-pruning}}
...
Klasse \texttt{AlphaBetaPruning} implementiert, die von der zuvor
definierten Klasse \texttt{ArtificialIntelligence} erbt. Hier wird
zunächst die Funktion \texttt{bestMoves} überschrieben, da diese vom
\texttt{ABC} Paket sonst fälschlicherweise als abstrakt erkannt werden
würde. Im weiteren Verlauf des Notebooks wird sie implementiert. Der
Konstruktor \texttt{\_\_init\_\_} erhält bereits hier seine
Implementierung und besitzt drei optionale Parameter, die den
Algorithmus konfigurieren können:
...
\item
  Hinweise (falls zum Beispiel eine ungültige Aktion ausgeführt worden
  ist) und
\item
    ...
    \PY{k}{with} \PY{n}{ipycanvas}\PY{o}{.}\PY{n}{hold\PYZus{}canvas}\PY{p}{(}\PY{n}{c}\PY{p}{)}\PY{p}{:}
        ...
        \PY{k}{if} \PY{n}{information} \PY{o+ow}{is} \PY{o+ow}{not} \PY{k+kc}{None}\PY{p}{:}
            ...
            \PY{k}{for} \PY{p}{(}\PY{n}{key}\PY{p}{,} \PY{n}{value}\PY{p}{)} \PY{o+ow}{in} \PY{n}{information}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
                \PY{k}{if} \PY{p}{(}\PY{n+nb}{isinstance}\PY{p}{(}\PY{n}{value}\PY{p}{,} \PY{n+nb}{int}\PY{p}{)}\PY{p}{)}\PY{p}{:}
                    \PY{n}{txt} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}:,\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{value}\PY{p}{)}
                \PY{k}{else}\PY{p}{:}
                    \PY{n}{txt} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}:,.2f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{value}\PY{p}{)}
                \PY{n}{c}\PY{o}{.}\PY{n}{fill\PYZus{}text}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{   }\PY{l+s+si}{\PYZob{}}\PY{n}{key}\PY{o}{.}\PY{n}{ljust}\PY{p}{(}\PY{l+m+mi}{16}\PY{p}{)}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{: }\PY{l+s+si}{\PYZob{}}\PY{n}{txt}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{TEXT\PYZus{}X}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{n}{max\PYZus{}width} \PY{o}{=} \PY{n}{TEXT\PYZus{}MAX\PYZus{}WIDTH}\PY{p}{)}
                \PY{n}{y} \PY{o}{+}\PY{o}{=} \PY{n}{TEXT\PYZus{}VERTICAL\PYZus{}PADDING}
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{class} \PY{n+nc}{Match}\PY{p}{(}\PY{p}{)}\PY{p}{:}
    \PY{k}{def} \PY{n+nf+fm}{\PYZus{}\PYZus{}init\PYZus{}\PYZus{}}\PY{p}{(}
        ...
        \PY{n}{max\PYZus{}turns}\PY{p}{:} \PY{n+nb}{int} \PY{o}{=} \PY{l+m+mi}{250}\PY{p}{,} \PY{n}{max\PYZus{}state\PYZus{}replayed}\PY{p}{:} \PY{n+nb}{int} \PY{o}{=} \PY{l+m+mi}{5}\PY{p}{,} \PY{n}{max\PYZus{}moves\PYZus{}without\PYZus{}mill}\PY{p}{:} \PY{n+nb}{int} \PY{o}{=} \PY{l+m+mi}{30}\PY{p}{,}
    ...
    \PY{p}{)}\PY{p}{:}
        ...
        \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{max\PYZus{}moves\PYZus{}without\PYZus{}mill} \PY{o}{=} \PY{n}{max\PYZus{}moves\PYZus{}without\PYZus{}mill}
...
\tightlist
\item
  \texttt{winner} \(\in Player \cup \{'\ '\}\), der Gewinner (oder
  Remis) des Spieles;
\item
  \texttt{log} ist die chronologische Liste aller gespielen Zustände;
\item
  \texttt{reason} eine Zeichenkette die genauer beschreibt warum das
  Spiel endete.
\end{itemize}
...
\end{tcolorbox}
    ...
    Die Hilfsfunktion \texttt{check\_draw} überprüft, ob der aktuelle
...
\tightlist
\item
  die maximale Anzahl an Zügen wurde gespielt - \texttt{max\_turns};
\item
  eine Stellung wurde öfter als maximal erlaubt gespielt -
  \texttt{max\_state\_replayed};
\item
  die maximale Anzahl an Zügen ohne eine neue Mühle wurde gespielt -
  \texttt{max\_moves\_without\_mill}.
\end{itemize}

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{check\PYZus{}draw}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{:} \PY{n}{Match}\PY{p}{)} \PY{o}{\PYZhy{}}\PY{o}{\PYZgt{}} \PY{n}{Optional}\PY{p}{[}\PY{n}{MatchResult}\PY{p}{]}\PY{p}{:}
    ...
    \PY{k}{if} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{log}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{state}\PY{p}{)} \PY{o}{\PYZgt{}}\PY{o}{=} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{max\PYZus{}state\PYZus{}replayed}\PY{p}{:}
        \PY{k}{return} \PY{n}{MatchResult}\PY{p}{(}
            \PY{n}{winner} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ }\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
            \PY{n}{log}    \PY{o}{=} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{log}\PY{p}{,}
            \PY{n}{reason} \PY{o}{=} \PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{State has been replayed for }\PY{l+s+si}{\PYZob{}}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{log}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{state}\PY{p}{)}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{ times}\PY{l+s+s2}{\PYZdq{}}
        \PY{p}{)}
    
    \PY{k}{if} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{no\PYZus{}mill\PYZus{}played} \PY{o}{\PYZgt{}}\PY{o}{=} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{max\PYZus{}moves\PYZus{}without\PYZus{}mill}\PY{p}{:}
        \PY{k}{return} \PY{n}{MatchResult}\PY{p}{(}
            \PY{n}{winner} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ }\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
            \PY{n}{log}    \PY{o}{=} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{log}\PY{p}{,}
            \PY{n}{reason} \PY{o}{=} \PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{No mill has been played for }\PY{l+s+si}{\PYZob{}}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{no\PYZus{}mill\PYZus{}played}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{ moves}\PY{l+s+s2}{\PYZdq{}}
        \PY{p}{)}
    \PY{k}{return} \PY{k+kc}{None}

\PY{n}{Match}\PY{o}{.}\PY{n}{check\PYZus{}draw} \PY{o}{=} \PY{n}{check\PYZus{}draw}
\PY{k}{del} \PY{n}{check\PYZus{}draw}
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{def} \PY{n+nf}{play}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{:} \PY{n}{Match}\PY{p}{)} \PY{o}{\PYZhy{}}\PY{o}{\PYZgt{}} \PY{n}{MatchResult}\PY{p}{:}
    \PY{k}{while} \PY{k+kc}{True}\PY{p}{:}
        \PY{n}{draw} \PY{o}{=} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{check\PYZus{}draw}\PY{p}{(}\PY{p}{)}
        \PY{k}{if} \PY{n}{draw} \PY{o+ow}{is} \PY{o+ow}{not} \PY{k+kc}{None}\PY{p}{:}
            \PY{k}{return} \PY{n}{draw}
        
        \PY{k}{if} \PY{n}{finished}\PY{p}{(}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{state}\PY{p}{,} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{player}\PY{p}{)}\PY{p}{:}
            \PY{c+c1}{\PYZsh{} Draw was already checked}
...
\end{tcolorbox}
    ...
    Obwohl die
\href{https://docs.python.org/3/library/multiprocessing.html\#introduction}{Dokumentation
der Bibliothek} beschreibt, dass Windows unterstützt wird, gibt es
Probleme falls diese mit \texttt{Jupyter} bzw. \texttt{IPython}
verwendet wird. Im Hauptprozess scheint es zwar so, als würden die
Prozesse gestartet worden sein, jedoch passiert ab dem Moment nichts
mehr.
...
Runde damit verschiedene Spiele stattfinden und startet das Spiel. Dafür
hat die Funktion einen Parameter:

\begin{itemize}
\tightlist
\item
  \texttt{match} ist ein Dupel bestehend aus dem Seed und der Runde
  eines Spiels.
\end{itemize}
...
\tightlist
\item
  \texttt{participants} ist eine Liste an Teilnehmer
...
\tightlist
\item
  \texttt{instances\_per\_round} ist die Anzahl der Spiele die pro Runde
  und pro Teilnehmer Konstellation gespielt werden soll;
\item
  \texttt{name} ist ein Name, der den Log-Dateien angehängt wird;
\item
  \texttt{skip} ist die Anzahl der Runden, die übersprungen werden
  sollen. Dies ist Hilfreich falls die Berechnungen abbrechen und
  fortgesetzt werden sollen;
\item
  \texttt{seed\_offset} ist die Zahl, die auf den Seed einer Runde
  addiert werden soll. So können Runden in Teilen ausgerechnet werden.
\end{itemize}
...
\tightlist
\item
  \texttt{idx} ist die Nummer der aktuellen Runde (wird um eins erhöht,
  um eine natürliche Zählung zu verwenden);
\item
  \texttt{rnd} ist die aktuelle Runde;
\item
  \texttt{results} ist die Liste der Ergebnisse, die gespeichert werden
  soll.
\end{itemize}
...
\PY{k}{def} \PY{n+nf}{save}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{:} \PY{n}{Tournament}\PY{p}{,} \PY{n}{idx}\PY{p}{:} \PY{n+nb}{int}\PY{p}{,} \PY{n}{rnd}\PY{p}{:} \PY{n}{Round}\PY{p}{,} \PY{n}{results}\PY{p}{:} \PY{n}{List}\PY{p}{[}\PY{n}{MatchResult}\PY{p}{]}\PY{p}{)}\PY{p}{:}
    ...
    \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{path}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{w}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)} \PY{k}{as} \PY{n}{file}\PY{p}{:}
        ...
        \PY{n}{file}\PY{o}{.}\PY{n}{write}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{  draw : }\PY{l+s+si}{\PYZob{}}\PY{n+nb}{sum}\PY{p}{(}\PY{n}{result}\PY{o}{.}\PY{n}{winner}\PY{o}{==}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ }\PY{l+s+s1}{\PYZsq{}} \PY{k}{for} \PY{n}{result} \PY{o+ow}{in} \PY{n}{results}\PY{p}{)}\PY{l+s+si}{\PYZcb{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
